...
// SmartAdLib
#define COCOAPODS_POD_AVAILABLE_SmartAdLib
#define COCOAPODS_VERSION_MAJOR_SmartAdLib 0
#define COCOAPODS_VERSION_MINOR_SmartAdLib 1
#define COCOAPODS_VERSION_PATCH_SmartAdLib 0
